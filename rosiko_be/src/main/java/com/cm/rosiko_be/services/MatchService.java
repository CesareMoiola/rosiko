...
import com.cm.rosiko_be.missions.*;
...
public class MatchService {
    ...
    public void selectAttacker(String territoryId){
        ...
        if(match.getPlayerOnDuty().equals(owner) && territory.getArmies() >= MINIMUM_ATTACKING_ARMIES){
    ...
    public void selectTerritoryFrom(String territoryId){
        Territory territory = match.getMap().getTerritory(territoryId);
        if(territory.getOwner().getId().equals(match.getPlayerOnDuty().getId()) && territory.getArmies() > MIN_ARMIES_FOR_TERRITORY){
