...
import com.cm.rosiko_be.controller.MatchesManager;
...
public class WSServices {
    ...
    @Autowired
    public MatchesManager matchesController;

    //Manda come messaggio la lista di joinableMatches
    public void notifyJoinableMatches (){
        messagingTemplate.convertAndSend("/queue/joinableMatches", matchesController.getAvailableMatches());
    }
